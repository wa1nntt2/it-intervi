...
Настраивает окружение для выполнения миграций.
"""
...
# Импортируем метаданные и модели из нашего приложения
from app.database.engine import Base, DATABASE_URL
from app.core.config import settings

# Импортируем все модели для корректной генерации миграций
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            render_as_batch=True,  # Важно для SQLite с batch mode
        )
